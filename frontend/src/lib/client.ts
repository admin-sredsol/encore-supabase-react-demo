// Code generated by the Encore v1.41.1 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-supabase-bf2i.encr.app`
}
...
/**
 * Client is an API client for the supabase-bf2i Encore application. 
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "supabase-bf2i-Generated-TS-Client (Encore/v1.41.1)";
        }
